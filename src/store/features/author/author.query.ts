...
import {
  PaginatedResponse,
  PaginatedResponseWithAuthorsRange,
...
export const authorApi = createApi({
  ...
  endpoints: build => ({
    ...
    >({
      ...
      transformResponse(
        baseQueryReturnValue: PaginatedResponseWithAuthorsRange<IFacetAuthor>
      ) {
    ...
    >({
      ...
      transformResponse(
        baseQueryReturnValue: PaginatedResponse<RawAuthorArticle>
      ) {
        const totalItems = baseQueryReturnValue['hydra:totalItems'];
        const formattedData = baseQueryReturnValue['hydra:member'].map(
          article => ({
