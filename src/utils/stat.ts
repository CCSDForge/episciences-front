...
export const statTypes: { labelPath: string; value: string }[] = [
  {
    labelPath: 'pages.statistics.types.nbSubmissions',
    value: STAT_TYPE.NB_SUBMISSIONS,
  },
  {
    labelPath: 'pages.statistics.types.acceptanceRate',
    value: STAT_TYPE.ACCEPTANCE_RATE,
  },
  {
  ...
  {
    labelPath: 'pages.statistics.types.evaluation',
    value: STAT_TYPE.EVALUATION,
  },
];
