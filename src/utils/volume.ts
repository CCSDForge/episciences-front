...
export const formatVolumeMetadata = (
...
export const volumeTypes: { labelPath: string; value: string }[] = [
  {
    labelPath: 'pages.volumes.types.specialIssues',
    value: VOLUME_TYPE.SPECIAL_ISSUE,
  },
  {
    labelPath: 'pages.volumes.types.proceedings',
    value: VOLUME_TYPE.PROCEEDINGS,
  },
];
