...
export default function ArticleDetailsDownload(): JSX.Element {
  ...
  const {
    ...
    isError,
    error,
  } = useFetchArticleQuery({ paperid: id! }, { skip: !id });
    ...
    <div className="articleDetailsDownload">
      <div className="articleDetailsDownload-header">
        ...
        <div className="articleDetailsDownload-header-buttons">
          <div
            className="articleDetailsDownload-header-download"
            onClick={handleDownload}
          >
            <img
              src={downloadIcon}
              className="articleDetailsDownload-header-download-icon"
              alt=""
            />
            <span className="articleDetailsDownload-header-download-text">
              {t('pages.pdfViewer.download')}
            </span>
          </div>
          <div
            className="articleDetailsDownload-header-close"
            onClick={handleCloseTab}
          >
            <img
              src={closeIcon}
              className="articleDetailsDownload-header-close-icon"
              alt=""
            />
            <span className="articleDetailsDownload-header-close-text">
              {t('pages.pdfViewer.closeTab')}
            </span>
          </div>
        </div>
      </div>
