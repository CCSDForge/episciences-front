...
export default function Indexation(): JSX.Element {
    ...
    const { data: indexationPage, isFetching } = useFetchIndexationPageQuery(rvcode!, { skip: !rvcode })
    ...
    return (
        <main className='indexation'>
            <Helmet>
                <title>{t('pages.indexation.title')} | {journalName ?? ''}</title>
            </Helmet>
                ...
                <div className='indexation-content'>
                    ...
                    <div className='indexation-content-body'>
                        <ReactMarkdown
                            ...
                            components={{
                                a: ({ ...props }) => (
                                    <Link to={props.href!} target='_blank' className='indexation-link'>
