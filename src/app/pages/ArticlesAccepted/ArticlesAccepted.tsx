...
export default function ArticlesAccepted(): JSX.Element {
  ...
  const { data: articlesAccepted, isFetching: isFetchingArticlesAccepted } =
  ...
  useEffect(() => {
    if (articlesAccepted) {
      const displayedArticlesAccepted = articlesAccepted?.data
      ...
      setEnhancedArticlesAccepted(
        displayedArticlesAccepted as EnhancedArticleAccepted[]
      );
    }
  ...
  return (
    <main className="articlesAccepted">
      <Helmet>
        <title>
          {t('pages.articlesAccepted.title')} | {journalName ?? ''}
        </title>
      </Helmet>
      ...
      <div className="articlesAccepted-title">
        <h1 className="articlesAccepted-title-text">
          {t('pages.articlesAccepted.title')}
        </h1>
        <div className="articlesAccepted-title-count">
          {articlesAccepted && articlesAccepted.totalItems > 1 ? (
            <div className="articlesAccepted-title-count-text">
              {articlesAccepted.totalItems} {t('common.documents')}
            </div>
          ) : (
            <div className="articlesAccepted-title-count-text">
              {articlesAccepted?.totalItems ?? 0} {t('common.document')}
            </div>
          )}
