...
export default function SectionArticleCard({
  ...
  t,
  article,
}: ISectionArticleCardProps): JSX.Element {
    ...
    <div className="sectionArticleCard">
      ...
      {article.abstract && (
        <div className="sectionArticleCard-abstract">
          ...
          >
            <div className="sectionArticleCard-abstract-title-text">
              {t('common.abstract')}
            </div>
            {openedAbstract ? (
              <img
      ...
      <div className="sectionArticleCard-anchor">
        ...
        <div className="sectionArticleCard-anchor-icons">
          {article.pdfLink && (
            <Link
              to={`/${PATHS.articles}/${article.id}/download`}
              target="_blank"
              rel="noopener noreferrer"
            >
              <div className="sectionArticleCard-anchor-icons-download">
                <img
                  className="sectionArticleCard-anchor-icons-download-download-icon"
                  src={download}
                  alt="Download icon"
                />
