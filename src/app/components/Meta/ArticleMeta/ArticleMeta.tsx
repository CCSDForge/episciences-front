  ...
  return (
    <Helmet>
      ...
      {article?.abstract && (
        <meta
          name="description"
          content={extractAbstractText(article.abstract)}
        />
      )}
      ...
      {currentJournal?.name && (
        <meta name="citation_journal_title" content={currentJournal.name} />
      )}
      {authors.length > 0 &&
        authors.map((author, index) => (
          <Fragment key={index}>
            ...
            {author.institutions &&
              ...
              author.institutions.map((institution, institutionIndex) => (
                <meta
      ...
      {article?.pdfLink && (
        <meta name="citation_pdf_url" content={article.pdfLink} />
      )}

      <meta
        name="citation_issn"
        content={
          currentJournal?.settings?.find(setting => setting.setting === 'ISSN')
            ?.value
        }
      />
      ...
      {article?.tag && (
        <meta name="citation_article_type" content={article.tag} />
      )}
      ...
      {article?.id && (
        <meta name="DC.identifier" content={article.id.toString()} />
      )}
      {article?.docLink && (
        <meta name="DC.identifier" content={article.docLink} />
      )}
      {article?.pdfLink && (
        <meta name="DC.identifier" content={article.pdfLink} />
      )}
      ...
      {currentJournal?.name && (
        <meta name="DC.relation.ispartof" content={currentJournal.name} />
      )}
      ...
      {article?.modificationDate && (
        <meta
          ...
          content={article.modificationDate}
        />
      )}
