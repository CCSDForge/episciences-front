...
export default function IssuesSection({
  ...
  issues,
  currentJournal,
}: IIssuesSectionProps): JSX.Element {
  return (
        ...
        <div key={index} className="issuesSection-card">
          {issue.tileImageURL ? (
            ...
            <div className="issuesSection-card-template">
              <div className="issuesSection-card-template-journal">
                {currentJournal?.code.toUpperCase()}
              </div>
              <div className="issuesSection-card-template-volume">
                {t('common.volumeCard.specialIssue')}
              </div>
              <div className="issuesSection-card-template-number">
                {issue.num}
              </div>
              <div className="issuesSection-card-template-year">
                {issue.year}
              </div>
            </div>
          )}
          <div className="issuesSection-card-text">
            ...
            <div className="issuesSection-card-text-title">
              {issue.title ? issue.title[language] : ''}
            </div>
            ...
            >
              <img
                ...
                alt="Download icon"
              />
              <div className="issuesSection-card-text-download-text">
                {t('common.pdf')}
              </div>
            </Link>
          </div>
