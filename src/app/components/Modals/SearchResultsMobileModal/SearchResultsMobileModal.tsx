...
interface ISearchResultsMobileModalProps {
  ...
  onUpdateSectionsCallback: (
    sections: ISearchResultsSectionSelection[]
  ) => void;
...
export default function SearchResultsMobileModal({
  ...
  onCloseCallback,
}: ISearchResultsMobileModalProps): JSX.Element {
  ...
  const [types, setTypes] =
    useState<ISearchResultsTypeSelection[]>(initialTypes);
  const [years, setYears] =
    useState<ISearchResultsYearSelection[]>(initialYears);
  const [volumes, setVolumes] =
    useState<ISearchResultsVolumeSelection[]>(initialVolumes);
  const [sections, setSections] =
    useState<ISearchResultsSectionSelection[]>(initialSections);
  const [authors, setAuthors] =
    useState<ISearchResultsAuthorSelection[]>(initialAuthors);
  ...
  return (
    <div className="searchResultsMobileModal" ref={modalRef}>
      <div className="searchResultsMobileModal-title">
        <div className="searchResultsMobileModal-title-text">
