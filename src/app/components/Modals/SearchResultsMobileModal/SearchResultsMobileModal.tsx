  ...
  return (
    <div className='searchResultsMobileModal' ref={modalRef}>
      <div className='searchResultsMobileModal-title'>
        ...
        <img className='searchResultsMobileModal-title-close' src={close} alt='Close icon' onClick={onClose} />
      </div>
      ...
      <div className='searchResultsMobileModal-filters'>
        <div className='searchResultsMobileModal-filters-types'>
          <div className='searchResultsMobileModal-filters-types-title'>
            ...
            <img className='searchResultsMobileModal-filters-types-title-caret' src={isOpenedSection(FILTERS_SECTION.TYPE) ? caretUpGrey : caretDownGrey} alt={isOpenedSection(FILTERS_SECTION.TYPE) ? 'Caret up icon' : 'Caret down icon'} onClick={(): void => toggleSection(FILTERS_SECTION.TYPE)} />
          </div>
        ...
        <div className='searchResultsMobileModal-filters-years'>
          <div className='searchResultsMobileModal-filters-years-title'>
            ...
            <img className='searchResultsMobileModal-filters-years-title-caret' src={isOpenedSection(FILTERS_SECTION.YEAR) ? caretUpGrey : caretDownGrey} alt={isOpenedSection(FILTERS_SECTION.YEAR) ? 'Caret up icon' : 'Caret down icon'} onClick={(): void => toggleSection(FILTERS_SECTION.YEAR)} />
          </div>
        ...
        <div className='searchResultsMobileModal-filters-volumes'>
          <div className='searchResultsMobileModal-filters-volumes-title'>
            ...
            <img className='searchResultsMobileModal-filters-volumes-title-caret' src={isOpenedSection(FILTERS_SECTION.VOLUME) ? caretUpGrey : caretDownGrey} alt={isOpenedSection(FILTERS_SECTION.VOLUME) ? 'Caret up icon' : 'Caret down icon'} onClick={(): void => toggleSection(FILTERS_SECTION.VOLUME)} />
          </div>
        ...
        <div className='searchResultsMobileModal-filters-sections'>
          <div className='searchResultsMobileModal-filters-sections-title'>
            ...
            <img className='searchResultsMobileModal-filters-sections-title-caret' src={isOpenedSection(FILTERS_SECTION.SECTION) ? caretUpGrey : caretDownGrey} alt={isOpenedSection(FILTERS_SECTION.SECTION) ? 'Caret up icon' : 'Caret down icon'} onClick={(): void => toggleSection(FILTERS_SECTION.SECTION)} />
          </div>
        ...
        <div className='searchResultsMobileModal-filters-authors'>
          <div className='searchResultsMobileModal-filters-authors-title'>
            ...
            <img className='searchResultsMobileModal-filters-authors-title-caret' src={isOpenedSection(FILTERS_SECTION.AUTHOR) ? caretUpGrey : caretDownGrey} alt={isOpenedSection(FILTERS_SECTION.AUTHOR) ? 'Caret up icon' : 'Caret down icon'} onClick={(): void => toggleSection(FILTERS_SECTION.AUTHOR)} />
          </div>
