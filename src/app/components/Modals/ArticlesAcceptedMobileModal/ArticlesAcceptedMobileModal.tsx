  ...
  return (
    <div className='articlesAcceptedMobileModal' ref={modalRef}>
      <div className='articlesAcceptedMobileModal-title'>
        ...
        <img className='articlesAcceptedMobileModal-title-close' src={close} alt='Close icon' onClick={onClose} />
      </div>
      ...
      <div className='articlesAcceptedMobileModal-filters'>
        <div className='articlesAcceptedMobileModal-filters-types'>
          <div className='articlesAcceptedMobileModal-filters-types-title'>
            ...
            <img className='articlesAcceptedMobileModal-filters-types-title-caret' src={isOpenedSection(FILTERS_SECTION.TYPE) ? caretUpGrey : caretDownGrey} alt={isOpenedSection(FILTERS_SECTION.TYPE) ? 'Caret up icon' : 'Caret down icon'} onClick={(): void => toggleSection(FILTERS_SECTION.TYPE)} />
          </div>
